...
wp_enqueue_style('hyc-admin', get_bloginfo('template_directory').'/css/hyc-admin.css', array(), '1.0');
wp_enqueue_script('jquery');
wp_enqueue_script('carrington', get_bloginfo('template_directory').'/js/carrington.js', array('jquery'), '1.0');
wp_enqueue_script('jquery.easing', get_bloginfo('template_directory').'/js/jquery.easing.1.3.js', array('jquery'), '1.0');
...
include_once(CFCT_PATH.'functions/meta-data-featured.php');
include_once(CFCT_PATH.'functions/meta-data-custom-user-fields.php');
include_once(CFCT_PATH.'functions/post-type-events.php');
include_once(CFCT_PATH.'functions/post-type-volunteer.php');
include_once(CFCT_PATH.'functions/post-type-announcements.php');
include_once(CFCT_PATH.'functions/navigation.php');
include_once(CFCT_PATH.'functions/hyc-functions.php');
